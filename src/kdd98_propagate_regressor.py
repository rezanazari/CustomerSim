...
if __name__ == '__main__':
    ...
    plot_validate(y_test.squeeze(), y_pred.squeeze(), xlab="Donation Amount", ylab="Probability Mass", name="../results/kdd98_regressor2.pdf",
    ...
    #
    # plot_validate(y_test, y_pred_rf, xlab="Donation Amount ($)", ylab="Probability Mass", name="../results/kdd98_regressor_rf2.pdf",
