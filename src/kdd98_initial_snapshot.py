...
data_subset = data[data['period'].isin([0, 1, 2, 3]) & ~data['customer'].isin(selected_customers)][cols].sample(1000,
...
plot_validate(data_subset["f0"], sampled_data['f0'], xlab="Frequency", ylab=False, name="../results/kdd98_f0.pdf",
              n_bins=4, x_range=(0, 4), y_range=(0, 1), font=28)
plot_validate(data_subset["m0"], sampled_data['m0'], xlab="Avg. Past Donation", ylab=False,
              name="../results/kdd98_m0.pdf",
              n_bins=6, x_range=(0, 30), y_range=(0, 1), bar_width=1.5, font=28, legend=True)
plot_validate(data_subset["ir0"], sampled_data['ir0'], xlab="Interaction Recency", ylab=False,
              name="../results/kdd98_ir0.pdf",
              n_bins=4, x_range=(0, 4), y_range=(0, 0.8), font=28)
plot_validate(data_subset["if0"], sampled_data['if0'], xlab="Interaction Frequency", ylab=False,
              name="../results/kdd98_if0.pdf",
              n_bins=4, x_range=(0, 4), y_range=(0, 0.8), font=28)
plot_validate(data_subset["gender"], sampled_data['gender'], xlab="Gender", ylab=False,
              name="../results/kdd98_gender.pdf",
              n_bins=4, x_range=(0, 4), y_range=(0, 0.8), font=28)
plot_validate(data_subset["zip_region"], sampled_data['zip_region'], xlab="Zip Region", ylab=False,
              name="../results/kdd98_zip_region.pdf",
...
plot_validate(data_subset["income"], sampled_data['income'], xlab="Income", ylab=False,
              name="../results/kdd98_income.pdf",
              n_bins=10, x_range=(0, 10), y_range=(0, 0.5), font=28)
...
record['KL_divergence_zip'] = str(
    KL_validate(data_subset["zip_region"], sampled_data['zip_region'], n_bins=10, x_range=(0, 10)))
record['KL_divergence_gender'] = str(
    KL_validate(data_subset["gender"], sampled_data['gender'], n_bins=3, x_range=(0, 3)))
record['KL_divergence_income'] = str(
    KL_validate(data_subset["income"], sampled_data['income'], n_bins=8, x_range=(0, 8)))
...
plot_validate_bivariate(data_subset["ir0"], data_subset["if0"], sampled_data['ir0'], sampled_data['if0'],
                        n_bins=(10, 10),
