...
if __name__ == '__main__':
    ...
    roc(to_categorical(y_test),y_score,name="../results/kdd98_propagation_classifier_roc2.pdf")
    ...
    #
    # # SAVE ROC CURVE PLOT
    # roc(to_categorical(y_test),y_score,name="../results/kdd98_propagation_classifier_roc_rf2.pdf")
